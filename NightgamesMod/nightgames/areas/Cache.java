...
public class Cache implements Deployable {
    ...
    public void gainMoney(Character active) {
        ...
        if (active.human()) {
            GameState.gui().message("You have found " + reward + "$!");
        }
    }
            ...
            if (active.check(test, dc)) {
                if (active.human()) {
                    switch (test) {
                        case Cunning:
                            ...
                            break;
                        case Perception:
                            GameState.gui().message("<br/><br/>Something is off in this "
                ...
                switch (test) {
                    case Cunning:
                        ...
                        break;
                    case Perception:
                        GameState.gui().message("<br/><br/>Something is off in this " + Match.getMatch().genericRoomDescription()
